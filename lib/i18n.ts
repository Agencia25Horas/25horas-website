...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "orcamento.form.mensagem": "A tua ideia — conta-nos o projeto",
  ...
  en: {
    ...
    "orcamento.form.mensagem": "Your idea — tell us about the project",
  ...
  es: {
    ...
    "orcamento.form.empresa": "Empresa",
    "orcamento.form.mensagem": "Tu idea — cuéntanos el proyecto",
    "orcamento.form.opcional": "opcional",
