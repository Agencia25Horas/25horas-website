...
// Black canvas, white text — matches the rest of the cinema-theatre frame.

export function ManifestoReel() {
  return (
    <section
      data-reel="2"
      className="relative min-h-[100svh] bg-canvas-black text-canvas-white flex items-center justify-center px-6"
    ...
    >
      <div className="max-w-[36rem] w-full pt-[calc(var(--chrome-h-mobile)+2rem)] pb-[calc(var(--chrome-h-mobile)+2rem)] md:pt-[calc(var(--chrome-h)+3rem)] md:pb-[calc(var(--chrome-h)+3rem)]">
        ...
        <p
          lang="pt"
          className="font-serif font-light text-[clamp(1.75rem,4.6vw,3rem)] leading-[1.22] text-canvas-white"
        >
          Não fazemos vídeos.
          <br />
        ...
        <p
          lang="pt"
          className="mt-7 font-serif font-light text-[clamp(1.5rem,3.6vw,2.25rem)] leading-[1.3] text-type-neutral"
        >
        ...
        <div className="mt-12">
          <span className="block h-px w-20 bg-type-dim/60 mb-3" aria-hidden />
